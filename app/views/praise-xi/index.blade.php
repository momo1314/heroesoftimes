<html>
	<head>
		...
		<script src="//wx.idsbllp.cn/game/game/js/praise-xi/ajax.js?d=vdds"></script>
		<script src="//wx.idsbllp.cn/game/game/js/praise-xi/main.js?d=vdds"></script>
		<script src="//wx.idsbllp.cn/game/game/js/praise-xi/API.js?d=vdsf"></script>
		<link rel="stylesheet" type="text/css" href="//wx.idsbllp.cn/game/game/css/praise-xi/style.css?v=v">
...
{{--				<img src="{{URL::asset('images/Xi-logo.png')}}" class="logo">--}}
				<img src="//wx.idsbllp.cn/game/game/images/Xi-logo.png" class="logo">
				<div class="slogan">
          ...
          <!--17-05-17 点击弹出版权信息-->
			...
			<div class="score" style="display: none">
				...
				<img src="//wx.idsbllp.cn/game/game/images/sharePage.png" class="share_tips">
				<img src="//wx.idsbllp.cn/game/game/images/over.png" class="over_star">
