...
{{--    <link rel="stylesheet" href="{{URL::asset('css/copyright-toast/toast.css')}}"/>--}}
    <script src="//wx.idsbllp.cn/game/game/resource/sun/jquery-2.1.1.min.js"></script>
    <link media="all" type="text/css" rel="stylesheet" href="//wx.idsbllp.cn/game/game/resource/sun/style.css">
    <script src="//wx.idsbllp.cn/game/game/resource/sun/game.js"></script>
...
{{--       {{HTML::image('resource/sun/loading.jpg')}}--}}
        <img src="//wx.idsbllp.cn/game/game/resource/sun/loading.jpg">
    </div>
    <div id="bg_web">
{{--        {{HTML::image('resource/sun/begin_bg.jpg',"tu",array('id'=>'begin_img'))}}--}}
        <img src="//wx.idsbllp.cn/game/game/resource/sun/begin_bg.jpg" id="begin_img" alt="tu">
        <p id="btn_list">
...
{{--        {{HTML::image('resource/sun/tips.jpg',"tu",array('id'=>'tips'))}}--}}
        <img src="//wx.idsbllp.cn/game/game/resource/sun/tips.jpg" id="tips" alt="tu">
        <span id="return">返回</span>
    </div>
    <div id="game_web">
{{--        {{HTML::image('resource/sun/games_bg.jpg',"tu",array('id'=>'games_bg'))}}--}}
        <img src="https://wx.idsbllp.cn/game/game/resource/sun/games_bg.jpg" id="games_bg" alt="tu">
        <div id="restart"></div>
        <div id="game_box">
        </div>
...
{{--        {{HTML::image('resource/sun/share.jpg',"tu",array('id'=>'share_img'))}}--}}
        <img src="//wx.idsbllp.cn/game/game/resource/sun/share.jpg" id="share_img" alt="tu">
        <p class="re_line">
            <input value="再来一次" id="reload">
        </p>
        <p id="Txtinput"><input type="text" placeholder="请输入手机号" id="phone_input"><span id="reply">提交</span></p>
        <p class="copyright" style="color: #333;">© 2017 红岩网校</p>
    </div>
