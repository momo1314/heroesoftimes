...
<head>
    ...
    <title>时代先锋问问答</title>
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/jquery-2.1.4.min.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js"></script>
    <link rel="stylesheet" href="//wx.idsbllp.cn/game/game/js/twolearnonedo/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.css">
    <link rel="stylesheet" href="//wx.idsbllp.cn/game/game/css/twolearnonedo/style.css">
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/styleSet.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/main.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/LoadQuestion.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/twolearnonedo/selectWord.js"></script>
...
<body>
    ...
    <div data-role="page" id="LeadPage">
        <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/lead_back.png" class="game-title">
        <div class="gameBack">
            “两学一做”学习教育，指的是“学党章党规、学系列讲话，做合格党员”学习教育。开展“两学一做”学习教育，是面向全体党员深化党内教育的重要实践，是推动党内教育从“关键少数”向广大党员拓展、从集中性教育向经常性教育延伸的重要举措。
        </div>
        <div class="beginBtn">
            <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/begin-btn.png" class="imgBtn">
        </div>
        <p class="copyright">
            ©红岩网校工作站
    ...
    <div data-role="page" id="Introduce">
        ...
        <div class="nextBtn">
            <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/nextBtn.png" class="imgBtn">
        </div>
        <p class="copyright">©红岩网校工作站</p>
    </div>
    <div data-role="page" id="rankPage">
        <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/rankTitle.png" class="rankTitle">
        <div class="rankBox">
        ...
        <div class="apply">
            <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/apply.png" class="applyImg">
        </div>
        <div class="share">
            <img src="//wx.idsbllp.cn/game/game/images/twolearnonedo/replay.png" class="shareImg">
        </div>
        <p class="copyright">©红岩网校工作站</p>
    </div>
    ...
    <script>
        ...
        var imgUrl = "//wx.idsbllp.cn/game/game/images/twolearnonedo/lead_back.png";
