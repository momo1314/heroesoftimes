...
<head>
    ...
    <title>我爱学党章</title>
    <script src="//wx.idsbllp.cn/game/game/js/party/jquery-2.1.4.min.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/party/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js"></script>
    <link rel="stylesheet" href="//wx.idsbllp.cn/game/game/js/party/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.css">
    <script src="//wx.idsbllp.cn/game/game/js/party/ImgLoad.js"></script>
    <script src="//wx.idsbllp.cn/game/game/js/party/main.js"></script>
    <link rel="stylesheet" type="text/css" href="//wx.idsbllp.cn/game/game/css/party/style.css">
...
<body>
    ...
    <div data-role="page" id="LeadPage">
        <div class="sloganBox">
            <img src="//wx.idsbllp.cn/game/game/images/party/slogan.png" alt="" class="slogan">
        </div>
        <div class="GameBack">
            “两学一做”学习教育，指的是“学党章党规、学系列讲话，做合格党员”学习教育。开展“两学一做”学习教育，是面向全体党员深化党内教育的重要实践，是推动党内教育从“关键少数”向广大党员拓展、从集中性教育向经常性教育延伸的重要举措。
        </div>
        <div class="beginBtn">
            <img src="//wx.idsbllp.cn/game/game/images/party/beginBtn.png" alt="" class="beginImg">
        </div>
        <p class="copyright">
            ©红岩网校工作站
    ...
    <div data-role="page" id="SelectPage">
        <img src="//wx.idsbllp.cn/game/game/images/party/sSlogan.png" alt="" class="sSlogan">
        <ul class="selector">
            <li level = "1">
                <img src="//wx.idsbllp.cn/game/game/images/party/btn1.png" alt="">
            </li>
            <li level = "2">
                <img src="//wx.idsbllp.cn/game/game/images/party/btn2.png" alt="">
            </li>
            <li level = "3">
                <img src="//wx.idsbllp.cn/game/game/images/party/btn3.png" alt="">
            </li>
            <li level = "4">
                <img src="//wx.idsbllp.cn/game/game/images/party/btn4.png" alt="">
            </li>
        </ul>
    ...
    <div data-role = "page" id = "RankPage">
        <img src="//wx.idsbllp.cn/game/game/images/party/overImg.png" alt="" class="overImg">
        ...
        <div class = 'apply'>
            <img src="//wx.idsbllp.cn/game/game/images/party/apply.png" alt="" class="overImg">
        </div>
        <div class = 'reload'>
            <img src="//wx.idsbllp.cn/game/game/images/party/again.png" alt="" class="overImg">
        </div>
        <p class="copyright">©红岩网校工作站</p>
    </div>
    ...
    <script>
        ...
        var link = "//wx.idsbllp.cn/game/game/learnpartyconstitution";
        var imgUrl = "//wx.idsbllp.cn/game/game/images/party/sSlogan.png";
