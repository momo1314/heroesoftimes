...
<head lang="zh-hans">
  ...
  <title>奔跑吧兄弟</title>
  <link media="all" type="text/css" rel="stylesheet" href="//wx.idsbllp.cn/game/game/resource/run/css/style.css">
  <script src="//wx.idsbllp.cn/game/game/resource/run/js/API.js"></script>
  <script src="//wx.idsbllp.cn/game/game/resource/run/js/normal.js"></script>
...
<body>
  ...
  <div id="container">
    ...
    <div id="loading">
      <img src="//wx.idsbllp.cn/game/game/resource/run/images/loading.jpg">
    </div>
    <div id="begin_web">
      {{--{{HTML::image("resource/run/images/begin_bg.jpg","tu",array('id'=>'begin_bg'))}}--}}
      <img src="//wx.idsbllp.cn/game/game/resource/run/images/begin_bg.jpg" id="begin_bg" alt="tu">
      <p id="btn_list">
    ...
    <div id="tips_web">
      ...
      <img src="//wx.idsbllp.cn/game/game/resource/run/images/tips.jpg" id="tips_img" alt="tu">
      <p class="tips_btn">
        <input class="btn_normal" 
          type="button" 
          value="开始游戏" 
...
{{--      {{HTML::image("resource/run/images/share.jpg","tu",array('id'=>'share_img'))}}--}}
      <img src="//wx.idsbllp.cn/game/game/resource/run/images/share.jpg" id="share_img" alt="tu">
      <p class="re_line">
        <input type="button" 
          value="再来一次" 
          id="reload">
