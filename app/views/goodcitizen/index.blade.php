...
<head lang="en">
	...
	<script src="//wx.idsbllp.cn/game/game/js/goodcitizen/jquery.min.js"></script>
	<script src="//wx.idsbllp.cn/game/game/js/goodcitizen/main.js"></script>
	<link rel="stylesheet" href="//wx.idsbllp.cn/game/game/css/goodcitizen/style.css">
...
<body>
	<img src="//wx.idsbllp.cn/game/game/images/goodcitizen/share.jpg" class="test" data="{{$token}}">
	<div class="container">
		...
		<div class='loading_page' style="z-index:9999">
			<img src='//wx.idsbllp.cn/game/game/images/goodcitizen/loading.jpg' class='load'>
		</div>
