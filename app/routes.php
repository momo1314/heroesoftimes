...
//view rank
//Route::get('/game/rankrrrr', 'RankController@index');

Route::post('takephotos', 'HomeController@takephotos');
Route::post('cqupt', array('as' => 'cqupt', 'uses' => 'HomeController@cqupt'));

//heroes of the times
Route::get('/{game}/heroesoftimes','HomeController@heroesoftimes');
Route::post('getquestionforhot','HomeController@hotquestion');
Route::post('recordscoreforhot','HomeController@hotRecord');
